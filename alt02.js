...
document.addEventListener('DOMContentLoaded', function() {
    const animateElements = document.querySelectorAll('.project-card, .skill, .blog-post');
...
document.addEventListener('DOMContentLoaded', function() {
    const sections = document.querySelectorAll('.hero, .about, .blog, .projects, .contact');
...
enhancedStyle.textContent = `
    ...
    .card-ripple {
        background: rgba(191, 109, 10, 0.3);
    }
    ...
    .hero, .about, .blog, .projects, .contact {
